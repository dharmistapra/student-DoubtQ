...
import Matchfollowservices from "./Matchfollowservices";
                    ...
                    <div className="row g-5 pb--60 pt--50 justify-content-between align-items-center">
                        <div className="col-lg-6">
                            <div className="banner-content">
                                <div className="inner">
                                    <h1 className="title">
                                        <span className="theme-gradient">Online Match The Following Help:</span>
                                        <br /> A+ Grades &amp; On-Time Submission-Time{" "}
                                    </h1>
                                    <p className="description">
                                        With DoubtQ's online Match The Following assistance, you'll never again be
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--30">
                                <h3 className="title">
                                    <span className="normal-text">Advantages of </span>Match The Following
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div className="row g-5 mx-auto">
                        ...
                        <div className="col-lg-6">
                            <div className="img-center d-flex justify-content-center">
                                <img src="/images/service/Matchfollw.svg" alt="img" width={352} />
                            </div>
                        </div>
                    </div>
                </div>
