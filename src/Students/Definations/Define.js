...
import Defineservices from "./Defineservices";
                    ...
                    <div className="row g-5 pb--60 pt--50 justify-content-between align-items-center">
                        <div className="col-lg-6">
                            <div className="banner-content">
                                <div className="inner">
                                    <h1 className="title">
                                        <span className="theme-gradient">Online Definition  Help:</span>
                                        <br /> A+ Grades &amp; On-Time Submission-Time{" "}
                                    </h1>
                                    <p className="description">
                                        With DoubtQ's online Definition assistance, you'll never again be
            ...
            <div className="mcq-banner pt--70">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--30">
                                <h3 className="title">
                                    <span className="normal-text">Advantages of </span>Definition
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div className="row g-5 mx-auto">
                        <div className="col-lg-6">
                            <h6 className="title">
                                <span className="theme-gradient">Definition :</span> is a statement that explains the meaning of a term<br />
                                (a word,phrase, or other set of symbols)
                            </h6>
                            <img src="/images/service/Definition.svg" alt="img" />
                        </div>
                        <div className="col-lg-6">
                            <h6 className="title">
                                <span className="theme-gradient">Sentence :</span> One way to clerify words i do not know when i
                                read is to look up the definition of the word in a dictionary
                            </h6>
                            <img src="/images/service/Definition1.svg" alt="img" />
                            <h6 className="title pt-4">
                                <span className="theme-gradient">Action :</span> pretend to open dictionary to look up
                                the definition of a word you do not know
                            </h6>
                        </div>
                    </div>
                </div>
