...
import Writingstudentsarea from "./Writingstudentsarea";

const Writinghelparea = () => {
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-start mb--20">
                                <h3 className="title">Who Is Writing Help For?</h3>
                            </div>
                            <p>
                                Every student will encounter multiple-choice questions (Writing) at some
                                ...
                                identify with the issues described here, our Writing assistance service
                                ...
                                more difficult. DoubtQ provides an online Writing assistance service for
                            ...
                            <ul className="plan-offer-list mt--20">
                                ...
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    don’t understand your Writing questions
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> Don’t
                                    have enough time to solve each Writing question
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    are lagging behind your classmates in Writing type question.
                                </li>
                                <li>
...
export default Writinghelparea;