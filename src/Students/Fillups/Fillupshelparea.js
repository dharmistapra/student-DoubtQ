...
import Fillupsstudentsarea from "./Fillupsstudentsarea";

const Fillupshelparea = () => {
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-start mb--20">
                                <h3 className="title">Who Is Fill In The Blanks Help For?</h3>
                            </div>
                            <p>
                                Every student will encounter multiple-choice questions (Fill In The Blanks) at some
                                ...
                                identify with the issues described here, our Fill In The Blanks assistance service
                                ...
                                more difficult. DoubtQ provides an online Fill In The Blanks assistance service for
                            ...
                            <ul className="plan-offer-list mt--20">
                                ...
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    don’t understand your Fill In The Blanks questions
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> Don’t
                                    have enough time to solve each Fill In The Blanks question
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    are lagging behind your classmates in Fill In The Blanks type question.
                                </li>
                                <li>
...
export default Fillupshelparea;