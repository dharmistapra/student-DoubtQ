...
import Shortanswerapparea from "./Shortanswerapparea";

const Shortanswerbonusarea = () => {
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        <h5 className="title mb--5">$ 1 Reward</h5>
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">for Variety of Short Answer Questions solution</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">
                                            Solutions on every Short Answer Questions solution
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">to your Short Answer Questions solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default Shortanswerbonusarea;