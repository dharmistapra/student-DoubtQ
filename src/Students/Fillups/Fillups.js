...
import Fillupsservices from "./Fillupsservices";
                    ...
                    <div className="row g-5 pb--60 pt--50 justify-content-between align-items-center">
                        <div className="col-lg-6">
                            <div className="banner-content">
                                <div className="inner">
                                    <h1 className="title">
                                        <span className="theme-gradient">Online Fill In The Blanks Help:</span>
                                        <br /> A+ Grades &amp; On-Time Submission-Time{" "}
                                    </h1>
                                    <p className="description">
                                        With DoubtQ's online Fill In The Blanks assistance, you'll never again be
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--30">
                                <h3 className="title">
                                    <span className="normal-text">Advantages of </span>Fill In The Blanks Method
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div className="row g-5 mx-auto">
                        ...
                        <div className="col-lg-5">
                            <div className="img-center d-flex justify-content-center">
                                <img src="/images/service/Fill-in-the-blank.svg" alt="img" width={280} />
                            </div>
                        </div>
                    </div>
                </div>
