...
import Defineapparea from "./Defineapparea";

const Definebonusarea = () => {
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">for Variety  Definition solution</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">
                                            Solutions on every Definition solution
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">to your Definition solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default Definebonusarea;