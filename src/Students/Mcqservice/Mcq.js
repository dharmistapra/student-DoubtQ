...
import Mcqservices from "./Mcqservices";
                    ...
                    <div className="row g-5 pb--60 pt--50 justify-content-between align-items-center">
                        <div className="col-lg-6">
                            <div className="banner-content">
                                <div className="inner">
                                    <h1 className="title">
                                        <span className="theme-gradient">Online MCQ Help:</span>
                                        <br /> A+ Grades &amp; On-Time Submission-Time{" "}
                                    </h1>
                                    <p className="description">
                                        With DoubtQ's online MCQ assistance, you'll never again be
            ...
            <div className="mcq-banner pt--70">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--30">
                                <h3 className="title">
                                    <span className="normal-text">Advantages of </span>Multiple
                                    Choice Questions
                                </h3>
                            </div>
                        </div>
                    ...
                    <div className="row g-5">
                        <div className="col-lg-6">
                            <img src="/images/service/mcq01.svg" alt="img" />
                        </div>
                        <div className="col-lg-6">
                            <img src="/images/service/mcq02.svg" alt="img" />
                        </div>
                        <div className="col-lg-6">
                            <img src="/images/service/mcq03.svg" alt="img" />
                        </div>
                        <div className="col-lg-6">
                            <img src="/images/service/mcq04.svg" alt="img" />
                        </div>
                    </div>
                </div>
            </div>
