...
import Mcqhelparea from "./Mcqhelparea";
                        ...
                        <div className="col-lg-7">
                            ...
                            <div className="bg-color-white radius-10 pr--20 pl--20 pb--10 pt--10 mb--20">
                                <div className="row align-items-center">
                                    <div className="col-lg-6 d-flex align-items-center border-end">
                                        ...
                                        <h5 className="d-inline mb--0 ">Place your MCQ Question</h5>
                                    </div>
                                    <div className="col-lg-6 pl--20">
                                        <p>
                                            On the dashboard, place your desired MCQ Question and upload
                                            your queries.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-color-white radius-10 pr--20 pl--20 pb--10 pt--10 mb--20">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-lg-6 pl--20">
                                        <p>
                                            Once payment is done, you will get Your MCQ Question answer
