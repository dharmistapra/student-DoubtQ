...
import Fillupsapparea from "./Fillupsapparea";

const Fillupsbonusarea = () => {
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">for Variety of Fill In The Blanks solution </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">
                                            Solutions on every Fill In The Blanks solution
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">to your Fill In The Blanks solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default Fillupsbonusarea;