...
import Matchfollowhelparea from "./Matchfollowhelparea";

const Matchfollowstepsarea = () => {
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--20">
                                <h3 className="title">Complete Match The Following Help in 4 Steps</h3>
                        ...
                        <div className="col-lg-7">
                            ...
                            <div className="bg-color-white radius-10 pr--20 pl--20 pb--10 pt--10 mb--20">
                                <div className="row align-items-center">
                                    <div className="col-lg-6 d-flex align-items-center border-end">
                                        ...
                                        <h5 className="d-inline mb--0 ">Place your Match The Following </h5>
                                    </div>
                                    <div className="col-lg-6 pl--20">
                                        <p>
                                            On the dashboard, place your desired Match The Following and upload
                                            your queries.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-color-white radius-10 pr--20 pl--20 pb--10 pt--10 mb--20">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-lg-6 pl--20">
                                        <p>
                                            Once payment is done, you will get Your Match The Following Question answer
...
export default Matchfollowstepsarea;