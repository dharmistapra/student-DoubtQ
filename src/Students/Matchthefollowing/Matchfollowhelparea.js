...
import Matchfollowstudentsarea from "./Matchfollowstudentsarea";

const Matchfollowhelparea = () => {
    ...
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-start mb--20">
                                <h3 className="title">Who Is Match The Following Help For?</h3>
                            </div>
                            <p>
                                Every student will encounter multiple-choice questions (Match The Following) at some
                                ...
                                identify with the issues described here, our Match The Following assistance service
                                ...
                                more difficult. DoubtQ provides an online Match The Following assistance service for
                            ...
                            <ul className="plan-offer-list mt--20">
                                ...
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    don’t understand your Match The Following questions
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> Don’t
                                    have enough time to solve each Match The Following question
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    are lagging behind your classmates in Match The Following type question.
                                </li>
                                <li>
            ...
            {/* end mcq help Area */}
            <Matchfollowstudentsarea />
        </>

    )
}

export default Matchfollowhelparea;