...
import Problemsolveservices from "./Problemsolveservices";
                    ...
                    <div className="row g-5 pb--60 pt--50 justify-content-between align-items-center">
                        <div className="col-lg-6">
                            <div className="banner-content">
                                <div className="inner">
                                    <h1 className="title">
                                        <span className="theme-gradient">Online Pratical Based Help:</span>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--30">
                                <h3 className="title">
                                    <span className="normal-text">Advantages of </span>Pratical Based Questions
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div className="row g-5 mx-auto">
                        <div className="col-lg-12">
                            <div className="img-center d-flex justify-content-center">
                                <img className="pratical-based" src="/images/service/pratical-based.png" alt="img" />
                            </div>
                        </div>
                    </div>
                </div>
