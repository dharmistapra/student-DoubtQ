...
import Writingapparea from "./Writingapparea";

const Writingbonusarea = () => {
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">for Variety of Writing solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">
                                            Solutions on every Writing solution
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">to your Writing solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default Writingbonusarea;