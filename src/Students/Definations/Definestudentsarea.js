...
import Definebonusarea from "./Definebonusarea";

const Definestudentsarea = () => {
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--20">
                                ...
                                <p className="description">Definition Type Questions</p>
                            </div>
                        </div>
                        <div className="col-lg-8 mx-auto bg-color-white shadow-1 radius-10">
                            <div className="pt--30 pb--30 pl--20 pr--20">
                                ...
                                <h6 className="">
                                    (i)
                                    Naturally occurring substance, that occurs in earth’s crust, in which metals are present in native or combined states is called mineral.
                                    Example: Magnetite, iron pyrite..
                                    <br /><br />
                                    (ii)
                                    Mineral from which metals can be extracted, conveniently and economically is called ore.
                                    Example-Haematite, calamine etc.
                                    <br /><br />
                                    (iii)
                                    The impurities present along with the pure metal in a particular ore, is known as gangue. Impurities can be separated from metal by using simple extraction processes. <br />
...
export default Definestudentsarea;