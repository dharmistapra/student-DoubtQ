...
import Longtheoryservices from "./Longtheoryservices";
                    ...
                    <div className="row g-5 pb--60 pt--50 justify-content-between align-items-center">
                        <div className="col-lg-6">
                            <div className="banner-content">
                                <div className="inner">
                                    <h1 className="title">
                                        <span className="theme-gradient">Online Long theory Help:</span>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center mb--30">
                                <h3 className="title">
                                    <span className="normal-text">Advantages of </span>Open-Ended Questions
                                </h3>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="rbt-card-bottom border-bottom pb--15 mb--10">
                                        <div className="icon-images">
                                            <div className="rbt-icon">
                                                <img src="/images/service/Longtheary1.svg" alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                    <h6 className="text-center">
                                        Allow for unlimited response
                                    </h6>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="rbt-card variation-01 rbt-hover">
                                <div className="rbt-card-body">
                                    <div className="rbt-card-bottom border-bottom pb--15 mb--10">
                                        <div className="icon-images">
                                            <div className="rbt-icon">
                                                <img src="/images/service/Longtheary6.svg" alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                    <h6 className="text-center">
                            ...
                            <div className="rbt-card variation-01 rbt-hover">
                                <div className="rbt-card-body">
                                    <div className="rbt-card-bottom border-bottom pb--15 mb--10">
                                        <div className="icon-images">
                                            <div className="rbt-icon">
                                                <img src="/images/service/Longtheary2.svg" alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                    <h6 className="text-center">
                            ...
                            <div className="rbt-card variation-01 rbt-hover">
                                <div className="rbt-card-body">
                                    <div className="rbt-card-bottom border-bottom pb--15 mb--10">
                                        <div className="icon-images">
                                            <div className="rbt-icon">
                                                <img src="/images/service/Longtheary5.svg" alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                    <h6 className="text-center">
                            ...
                            <div className="rbt-card variation-01 rbt-hover">
                                <div className="rbt-card-body">
                                    <div className="rbt-card-bottom border-bottom pb--15 mb--10">
                                        <div className="icon-images">
                                            <div className="rbt-icon">
                                                <img src="/images/service/Longtheary4.svg" alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                    <h6 className="text-center">
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="rbt-card variation-01 rbt-hover">
                                <div className="rbt-card-body">
                                    ...
                                    <h6 className="text-center">
                                        Follow the whole Customer joureny
                                    </h6>
                                </div>
                            </div>
                        </div>
