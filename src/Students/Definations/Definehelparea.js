...
import Definestudentsarea from "./Definestudentsarea";

const Definehelparea = () => {
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-start mb--20">
                                <h3 className="title">Who Is Definition Help For?</h3>
                            </div>
                            <p>
                                Every student will encounter multiple-choice questions (Definition) at some
                                ...
                                identify with the issues described here, our Definition assistance service
                                ...
                                more difficult. DoubtQ provides an online Definition assistance service for
                            ...
                            <ul className="plan-offer-list mt--20">
                                ...
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    don’t understand your Definition questions
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> Don’t
                                    have enough time to solve each Definition question
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    are lagging behind your classmates in Definition type question.
                                </li>
                                <li>
