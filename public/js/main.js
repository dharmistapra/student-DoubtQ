    ...
    var eduJs = {
        ...
        TimeCount: function() {
            if ($('#time-countdown').length) {
                ...
                // var countDownDate = new Date("march 15, 2023 15:25").getTime();
                var countDownDate = new Date("2024 15:25").getTime();
                ...
                var x = setInterval(function() {
                    ...
                    document.getElementById("time-countdown").innerHTML = minutes + "m " + seconds + "s ";
