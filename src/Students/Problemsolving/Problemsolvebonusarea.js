...
import Problemsolveapparea from "./Problemsolveapparea";

const Problemsolvebonusarea = () => {
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">for Variety of Pratical Based solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">
                                            Solutions on every Pratical Based solution
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rbt-cat-box rbt-cat-box-1 text-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="description mb--20">to your Pratical Based solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default Problemsolvebonusarea;