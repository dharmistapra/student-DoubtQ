                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-start mb--20">
                                <h3 className="title">Who Is MCQ Help For?</h3>
                            </div>
                            <p>
                                Every student will encounter multiple-choice questions (MCQ) at some
                                ...
                                identify with the issues described here, our MCQ assistance service
                                ...
                                more difficult. DoubtQ provides an online MCQ assistance service for
                            ...
                            <ul className="plan-offer-list mt--20">
                                ...
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    don’t understand your MCQ questions
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> Don’t
                                    have enough time to solve each MCQ question
                                </li>
                                <li>
                                    <i className="theme-gradient feather-arrow-right-circle" /> You
                                    are lagging behind your classmates in MCQ type question.
                                </li>
                                <li>
